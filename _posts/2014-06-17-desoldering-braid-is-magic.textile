...
The first draft of thie prototype was... messy.  I sat and thought about every connection, then soldered, then sat and thought some more. This is a fast way to build a watch. This version of the setup worked, for a loose definition of 'work'. I used really long jumper wires, and tried to pack them all together, so, of course, there were shorts. It also made the whole package considerably bigger than I thought it would be. So, kind of a dud.
